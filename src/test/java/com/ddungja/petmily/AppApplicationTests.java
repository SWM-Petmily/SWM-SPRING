...
class AppApplicationTests {
    ...
    public void apply() {
        ...
        for (PostStatusType value : PostStatusType.values()) {
            for (int i = 0; i < 50; i++) {
                System.out.println("('입양자', '장점','평균비용','2022-03',now(),'단점','MALE',1,'100000','테스트','YES','이유','서울',1,'"+value+"',1,'https://encrypted-tbn1.gstatic.com/licensed-image?q=tbn:ANd9GcREj22c-wMNL5IDmU99v8G7voUl17Yxm0JJqMLqttdPT4DnaB99zqVK7HWiNzjP3aZnzCEf-ikAqb2yiDk',now(),1,1,"+num+"),");
                num++;
            }
        }
