...
-- user
insert into users (user_id, email, nickname, phone, provider, birth, create_date, update_date, is_profile)
values (1, 'rldh11111@naver.com', '권기오', '01063169037', 'kakao', '0713', now(), now(), true);

insert into users (user_id, email, nickname, phone, provider, birth, create_date, update_date, is_profile)
values (2, 'rldh9037@naver.com', '김아란', '01012345678', 'kakao', '0613', now(), now(), false);

insert into users (user_id, email, nickname, phone, provider, birth, create_date, update_date, is_profile)
values (3, 'rldh6316@naver.com', '오승기', '01011112222', 'kakao', '0402', now(), now(), false);
