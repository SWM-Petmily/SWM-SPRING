...
//        this.messageService = new DefaultMessageService(environment.getProperty("coolsms.apiKey"), environment.getProperty("coolsms.apiSecretKey"), "https://api.coolsms.co.kr");
//    }
//
...
//        }
//
//        message.setText("[펫밀리] 본인확인 인증번호[" + certificationNumber + "]입니다. \"타인 노출 금지\"");
