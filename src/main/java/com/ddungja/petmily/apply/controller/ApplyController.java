...
public class ApplyController {
    ...
    @GetMapping("/{postId}")
    public ResponseEntity<Page<ApplySupportResponse>> getByPostId(@AuthenticationPrincipal User user, @PathVariable Long postId, Pageable pageable) {
    ...
    @GetMapping
    public ResponseEntity<Page<ApplyPostListResponse>> getByUserId(@AuthenticationPrincipal User user, ApprovalType status, Pageable pageable) {
    ...
    public ResponseEntity<ApplyDetailResponse> getDetail(@AuthenticationPrincipal User user, @PathVariable Long applyId) {
    ...
    public ResponseEntity<ApprovalResponse> approve(@AuthenticationPrincipal User user, @PathVariable Long applyId, @Valid @RequestBody ApproveRequest approveRequest) {
    ...
    @PostMapping("/{postId}")
    public ResponseEntity<ApplyCreateResponse> apply(@AuthenticationPrincipal User user, @PathVariable Long postId, @Valid @RequestBody ApplyCreateRequest applyCreateRequest) {
        log.info("지원하기 userId = {}, postId = {}", user.getId(), postId);
        return ResponseEntity.status(HttpStatus.CREATED).body(ApplyCreateResponse.from(applyService.apply(user.getId(), postId, applyCreateRequest)));
    }
    ...
    public ResponseEntity<ApplyCancelResponse> cancel(@AuthenticationPrincipal User user, @PathVariable Long postId) {
    ...
    @PutMapping("/{applyId}")
    public ResponseEntity<ApplyUpdateResponse> modify(@AuthenticationPrincipal User user, @PathVariable Long applyId, @RequestBody ApplyUpdateRequest applyUpdateRequest) {
